module.exports = {
  ...
  async createObjects(id, name) {
    ...
    if (name === 'settings') {
      ...
      await this.createDataPoint(id, common, 'channel', null, null);
      return;
    }
    if (name === 'events') {
      common = {
    ...
    if (name === 'available') {
      ...
      await this.createDataPoint(id, common, 'folder', null, null);
      return;
    }
    if (name === 'options') {
      common = {
  ...
  async createDevices(id, name, device) {
    ...
    await this.createDataPoint(id, common, 'device', null, null);
    common = {
      name: {
        en: 'Commands',
        de: 'Befehle',
    ...
    await this.createDataPoint(`${id}.commands`, common, 'channel', null, null);
    common = {
      name: {
        en: 'Commands',
        de: 'Befehle',
    ...
    await this.createDataPoint(`${id}.general`, common, 'channel', null, null);
    ...
    if (pause.includes(this.typeJson[id])) {
      ...
      await this.createDataPoint(`${id}.commands.BSH_Common_Command_PauseProgram`, common, 'state', false, null);
    }
    ...
    if (resume.includes(this.typeJson[id])) {
      ...
      await this.createDataPoint(`${id}.commands.BSH_Common_Command_ResumeProgram`, common, 'state', false, null);
    }
    ...
    if (openDoor.includes(this.typeJson[id])) {
      ...
      await this.createDataPoint(`${id}.commands.BSH_Common_Command_OpenDoor`, common, 'state', false, null);
    }
    ...
    if (partlyOpenDoor.includes(this.typeJson[id])) {
      ...
      await this.createDataPoint(`${id}.commands.BSH_Common_Command_PartlyOpenDoor`, common, 'state', false, null);
    }
    ...
    await this.createDataPoint(`${id}.commands.BSH_Common_Command_StopProgram`, common, 'state', false, null);
    for (const key in device) {
      ...
      await this.createDataPoint(`${id}.general.${key}`, common, 'state', device[key], null);
    }
  },
  /**
   * @param {string} ident
